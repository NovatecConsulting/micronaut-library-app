...
internal class BooksControllerIntTest(
        @Inject val bookDataStore: BookDataStore,
        @Inject val bookIdGenerator: BookIdGenerator,
        @Inject val booksController: BooksController,
        @Inject val clock: MutableClock
) {
