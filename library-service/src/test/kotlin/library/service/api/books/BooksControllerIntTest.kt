...
class BooksControllerIntTest {
    ...
    // BooksEndpoint
    @Test
    fun `when there are no books, the response is empty`() {
    ...
    @Test
    fun `when there are books, the response contains them`() {
    ...
    fun `400 BAD REQUEST for invalid ISBN`() {
        ...
        RestAssured.given().contentType(MediaType.APPLICATION_JSON).header("X-Correlation-ID", correlationId)
            .body(requestBody)
            .`when`().post("/api/books").then()
    ...
    @Test
    fun `415 UNSUPPORTED MEDIA for missing content type in header request`() {
        val requestBody = """ """
        val expectedResponse = """
                    {
                ...
                """
        RestAssured.given().body(requestBody).header("X-Correlation-ID", correlationId)
            .`when`().post("/api/books").then()
    ...
    @Test
    fun `404 NOT FOUND for non-existing book to delete`() {
        val request = "/api/books/$id"
        val expectedResponse = """
                        {
                          "status": 404,
    ...
    @Test
    fun `400 BAD REQUEST for book with malformed ID to delete`() {
        val request = "/api/books/malformed-id"
        val expectedResponse = """
                        {
                          "status": 400,
    ...
    @Test
    fun `404 NOT FOUND for non-existing book where authors should be replaced`() {
        val request = "/api/books/$id/authors"
        val expectedResponse = """
                        {
                          "status": 404,
    ...
    @Test
    fun `400 BAD REQUEST for missing required properties of book where authors should be replaced`() {
        val request = "/api/books/$id/authors"
        val expectedResponse = """
                    {
                      "status": 400,
    ...
    @Test
    fun `404 NOT FOUND for non-existing book where authors should be deleted`() {
        val request = "/api/books/$id/authors"
        val expectedResponse = """
                            {
                              "status": 404,
    ...
    @Test
    fun `404 NOT FOUND for non-existing book to be borrowed`() {
        val request = "/api/books/$id/borrow"
        val expectedResponse = """
                            {
                              "status": 404,
    ...
    @Test
    fun `400 BAD REQUEST for missing required properties of book to be borrowed`() {
        val request = "/api/books/$id/borrow"
        val expectedResponse = """
                            {
                              "status": 400,
    ...
    @Test
    fun `400 BAD REQUEST for malformed request of book to be borrowed`() {
        val request = "/api/books/$id/borrow"
        val expectedResponse = """
                            {
                              "status": 400,
        ...
        RestAssured.given().contentType(MediaType.APPLICATION_JSON).body("").header("X-Correlation-ID", correlationId)
            .`when`().post(request).then()
            .statusCode(HttpStatus.BAD_REQUEST.code)
            .contentType(MediaType.APPLICATION_JSON)
            .header("X-Correlation-ID", correlationId)
    ...
    @Test
    fun `400 BAD REQUEST for malformed ID of book to be borrowed`() {
    ...
    @Test
    fun `404 NOT FOUND for non-existing book where number of pages should be replaced`() {
        val request = "/api/books/$id/numberOfPages"
        val expectedResponse = """
                            {
                              "status": 404,
    ...
    @Test
    fun `400 BAD REQUEST for missing required properties for book where number of pages should be replaced`() {
    ...
    @Test
    fun `404 NOT FOUND for non-existing book where number of pages should be removed`() {
        val request = "/api/books/$id/numberOfPages"
        val expectedResponse = """
                            {
                              "status": 404,
    ...
    @Test
    fun `404 NOT FOUND for non-existing book to be returned`() {
        val request = "/api/books/$id/return"
        val expectedResponse = """
                            {
                              "status": 404,
    ...
    @Test
    fun `400 BAD REQUEST for malformed ID of book to be returned`() {
    ...
    @Test
    fun `404 NOT FOUND for non-existing book where title should be replaced`() {
        val request = "/api/books/$id/title"
        val expectedResponse = """
                            {
                              "status": 404,
        ...
        RestAssured.given().contentType(MediaType.APPLICATION_JSON).body(""" { "title": "New Title" } """)
            ...
            .`when`().put(request).then()
            .statusCode(HttpStatus.NOT_FOUND.code)
            .contentType(MediaType.APPLICATION_JSON).header("X-Correlation-ID", correlationId)
            .body(JsonMatcher.jsonEqualTo(expectedResponse))
    }

    @Test
    fun `400 BAD REQUEST for missing required properties for book where title should be replaced`() {
        val idValue = BookId.generate().toString()
